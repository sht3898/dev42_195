<template>
    <header style="min-height:0">
        ...
        <v-list-item-group>
            ...
            <v-list-item
                v-if="!isLoginsub"
                @click="bannerClick('로그인')"
            >
            <v-list-item-content style="color:white; font-size:1rem;font-weight:bold;margin:auto">로그인</v-list-item-content>
            </v-list-item>
    ...
    methods: {
        ...
        myInfoSubClick(title){
            if(title==="로그아웃"){
                ...
                this.$router.push('/testpage')//mypage
            }
        },
        searching(){
            if (this.content == ''){

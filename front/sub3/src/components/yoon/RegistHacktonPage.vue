...
<v-row justify="center" style="margin-bottom:5vw">
    <v-card width="80vw" img ="https://www.onlygfx.com/wp-content/uploads/2017/07/yellow-watercolor-brush-stroke-4.png" color="white">
        <v-container>
        <v-card-title >
  ...
  methods:{
    init(){
      ...
      .then(response=>{
        ...
        this.user = response.data.member.email
      })
    },
